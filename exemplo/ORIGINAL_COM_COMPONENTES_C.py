...
class TemplateMatchingApp:
    def __init__(self, root):
        ...
        self.status_label.grid(row=2, column=0, padx=5, pady=5, columnspan=2)
         ...
         # Barra de progresso
        self.progress = ttk.Progressbar(self.control_frame, orient="horizontal", length=200, mode="determinate")
        self.progress.grid(row=3, column=0, padx=5, pady=5, columnspan=2)

        # Label para mostrar o tempo
        self.time_label = tk.Label(self.control_frame, text="Tempo: 0s", font=('Helvetica', 10))
        self.time_label.grid(row=4, column=0, padx=5, pady=5, columnspan=2)
