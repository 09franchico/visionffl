...
#         ax.scatter(detector.keypoints[:, 1], detector.keypoints[:, 0], marker='o', facecolors='none', edgecolors='r')
#         ax.set_title('CENSURE Keypoints')
...
# # Configuração da janela principal do tkinter
# window = tk.Tk()
# window.title("Detector de Características CENSURE")
